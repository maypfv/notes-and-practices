...
const special_unassigned_value = pair(null, null);

function list_of_unassigned(symbols) {
    return map(symbol => special_unassigned_value, symbols);
}
    ...
    function env_loop(env) {
        function scan(symbols, vals) {
            return is_null(symbols)
                   ...
                   : symbol === head(symbols)
                   ? head(vals) === special_unassigned_value ? error(head(symbols), "Reference error") : head(vals)
